...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		UserFilesAbsolutePath = Server.MapPath(UserFilesPath);
		...
		TypeConfig[ "File" ].QuickUploadPath			= "%UserFilesPath%files/";
		TypeConfig[ "File" ].QuickUploadAbsolutePath	= ( UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%files/" );
		...
		TypeConfig[ "Image" ].QuickUploadPath			= "%UserFilesPath%images/";
		TypeConfig[ "Image" ].QuickUploadAbsolutePath	= ( UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%images/" );
